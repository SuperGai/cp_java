...
@Service
//生成PDF线程类
public class GeneraPdfAsyncTaskService3 {
...
//		//是否完成答题改成是
		...
		String logo = "http://101.34.103.174:8888/file/logo/1626315684758logo.png";
//				fileConfig.pdfUrl + school.getLogo();

		// 替换logo
		Map<String, String> imgMap = new HashMap<String, String>();
		imgMap.put("整体测评情况图示参照下图表替换位置", "/Users/gaigai/Documents/work/项目/精派咨询/111.png");
...
//		InputStream is = new FileInputStream(new File(fileConfig.reportModel));
		InputStream is = new FileInputStream(new File("/Users/gaigai/Documents/work/项目/精派咨询/中学生心理健康测评报告.docx"));
...
//        XWPFDocument doc, List<String> titleArr, List<String> fldNameArr, List<Map<String, String>> listItemsByType,Map<String, String> textMap, Map<String, String> imgMap
		...
		//处理EXCEL
		PoiWordTools.dealExcel("/Users/gaigai/Documents/work/项目/精派咨询/model.xlsx", "/Users/gaigai/Documents/work/项目/精派咨询/111.xlsx",items);
		
		WordToPdf.xls2image("/Users/gaigai/Documents/work/项目/精派咨询/111.xlsx", "/Users/gaigai/Documents/work/项目/精派咨询/111.png");
...
//		String pdfUrl = fileConfig.reportOutFolder + reportName + ".pdf";
		String wordUrl ="/Users/gaigai/Documents/work/项目/精派咨询/" + reportName + ".docx";
		String pdfUrl = "/Users/gaigai/Documents/work/项目/精派咨询/" + reportName + ".pdf";
