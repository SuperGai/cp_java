...
public interface DivisorService extends IService<Divisor> {
     ...
     * @return
     */
    DivisorBean findByCode(String code);
     ...
     * @return
     */
    List<DivisorBean> findByCodeList(List<String> codeList);
     ...
     * @return
     */
    List<DivisorBean> findList(DivisorBean bean);
     ...
     * @return
     */
    Page<DivisorBean> findPage(DivisorBean bean, PageBean pageBean);
     ...
     * @return
     */
    DivisorBean add(DivisorBean bean);
     ...
     * @return
     */
    int updateByCode(DivisorBean bean);
