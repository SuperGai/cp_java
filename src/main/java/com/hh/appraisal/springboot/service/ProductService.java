...
public interface ProductService extends IService<Product> {
     ...
     * @return
     */
    List<ProductBean> findByCodeList(List<String> codeList);
     ...
     * @return
     */
    List<ProductBean> findList(ProductBean bean);
     ...
     * @return
     */
    Page<ProductBean> findPage(ProductBean bean, PageBean pageBean);
     ...
     * @return
     */
    ProductBean add(ProductBean bean);
     ...
     * @return
     */
    int updateByCode(ProductBean bean);
