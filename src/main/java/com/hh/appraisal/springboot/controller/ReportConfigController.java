...
public class ReportConfigController {
    ...
    public RestBean listPage(ReportConfigBean bean, PageBean pageBean){
        Page<ReportConfigBean> page = reportConfigService.findPage(bean,pageBean);
    ...
    public RestBean detail(String code) {
        ...
        ReportConfigBean bean = reportConfigService.findByCode(code);
    ...
    public RestBean add(ReportConfigBean bean){
        return RestBean.ok(reportConfigService.add(bean));
    }
    ...
    public RestBean update(ReportConfigBean bean){
        if(bean == null || ObjectUtils.isEmpty(bean.getCode())) {
            return RestBean.error(RestCode.DEFAULT_PARAMS_ERROR);
        }
        return RestBean.ok(reportConfigService.updateByCode(bean));
    }
    ...
    public RestBean delete(String code){
        ...
        return RestBean.ok(
            reportConfigService.deleteByCode(code)
        );
    }
    ...
    public RestBean batchDelete(@RequestParam("codeList") List<String> codeList){
        ...
        reportConfigService.deleteByCode(codeList);
        return RestBean.ok();
    }
