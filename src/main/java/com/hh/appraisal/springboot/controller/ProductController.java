...
public class ProductController {
    ...
    public RestBean listPage(ProductBean bean, PageBean pageBean){
        Page<ProductBean> page = productService.findPage(bean,pageBean);
    ...
    public RestBean detail(String code) {
        ...
        ProductBean bean = productService.findByCode(code);
    ...
    public RestBean add(ProductBean bean){
        return RestBean.ok(productService.add(bean));
    }
    ...
    public RestBean update(ProductBean bean){
        if(bean == null || ObjectUtils.isEmpty(bean.getCode())) {
            return RestBean.error(RestCode.DEFAULT_PARAMS_ERROR);
        }
        return RestBean.ok(productService.updateByCode(bean));
    }
    ...
    public RestBean batchDelete(@RequestParam("codeList") List<String> codeList){
        ...
        productService.deleteByCode(codeList);
        return RestBean.ok();
    }
