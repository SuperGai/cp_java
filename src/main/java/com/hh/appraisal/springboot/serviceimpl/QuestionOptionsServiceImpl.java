...
public class QuestionOptionsServiceImpl extends ServiceImpl<QuestionOptionsMapper, QuestionOptions> implements QuestionOptionsService {
    ...
    public QuestionOptionsBean findByCode(String code){
        ...
        List<QuestionOptions> sourceList = questionOptionsMapper.selectList(
                createWrapper(QuestionOptionsBean.builder().code(code).build())
        );
    ...
    public List<QuestionOptionsBean> findByCodeList(List<String> codeList){
        ...
        List<QuestionOptions> sourceList = questionOptionsMapper.selectList(
                createWrapper(QuestionOptionsBean.builder().questionOptionsCodeList(codeList).build())
        );
    ...
    public Page<QuestionOptionsBean> findPage(QuestionOptionsBean bean, PageBean pageBean){
        Page<QuestionOptions> sourcePage = questionOptionsMapper.selectPage(
